...
function setPhotoEvent() {
    ...
    document.getElementById('photoCalculate').src = Tools.urlToImage + "?filename=" + photoArray[photoEventIndex] + "&type=jpeg&";
    document.getElementById('photoId').src = Tools.urlToImage + "?filename=" + photoArray[photoEventIndex] + "&type=jpeg&";
    document.getElementById('photoRefId').href = Tools.urlToImage + "?filename=" + photoArray[photoEventIndex] + "&type=jpeg&";
    /*
